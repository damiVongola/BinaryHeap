...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
    ...
    protected Node<E> root = null;      //root of the trees
    ...
    protected Node<E> validate(Position<E> p) throws IllegalArgumentException {
        ...
        if (node.getParent() == node) //our bconvention for defunct node     
        {
    ...
    public E remove(Position<E> p) throws IllegalArgumentException {
        ...
        if (child != null) {
            child.setParent(node.getParent());  //childs grandparent becomes its parent
        }
        if (node == root) {
        ...
        node.setRight(null);
        node.setParent(node);
        return temp;                         //our convention for defunct node
    }
}
